                            ...
                            <div class="col-12">
                                <div class="woocommerce-billing-fields">
                                    ...
                                    <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                        <label class="" for="billing_country">City of Kathmandu Valley<abbr title="required" class="required">*</abbr>
                                        </label>
                                        <select class="country_to_state country_select" id="billing_country" name="city" required="">
                                            ...
                                            <option value="pepsi">Pepsikola</option>
                                    ...
                                    <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                        <label class="" for="billing_phone">Phone (98XXXXXXXX)<abbr title="required" class="required">*</abbr>
                                        </label>
